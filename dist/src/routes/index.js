...
const academicCenterRoutes_1 = require("../modules/users/academic_center_professor/routes/academicCenterRoutes");
...
router.use("/professor", academicCenterRoutes_1.academicCenterRouter);
...
router.use('/refreshtoken', refreshToken_routes_1.refreshTokenRouter);
