...
exports.RemoveStudentCAService = void 0;
const client_1 = require("@prisma/client");
const AppError_1 = require("../../../../errors/AppError");
const prisma_1 = __importDefault(require("../../../../prisma"));
class RemoveStudentCAService {
    async execute({ studentId, userId }) {
        ...
        if (!student.roles.includes(client_1.Role.STUDENT)) {
            throw new AppError_1.AppError("User to be removed from Academic Center is not a Student.", 400);
        }
...
exports.RemoveStudentCAService = RemoveStudentCAService;
